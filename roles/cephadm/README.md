...
| cephadm_registry_url      | No       | String |              | URL of the container registry. If not set, a local podman registry mirror is used     |
| cephadm_registry_username | No*      | String |              | Username for the container registry. Required if `cephadm_registry_url` is set        |
| cephadm_registry_password | No*      | String |              | Password for the container registry. Required if `cephadm_registry_url` is set        |
